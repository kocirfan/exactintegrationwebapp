...
public class CustomersComparisonController : ControllerBase
{
    ...
    //         _logger.LogInformation($"   - Top Müşteri Sayısı: {filter.TopCount}");
    ...
    //         // Karşılaştırma yap
    //         var result = await _customerReports.ComparePeriodsAsync(currentTP, previousTP, filter);
    ...
    // public async Task<IActionResult> YesterdayVsToday([FromQuery] ReportFilterModel filter = null)
    // {
    //     filter ??= new ReportFilterModel();
    //     try
    //     {
    ...
    // public async Task<IActionResult> ThisWeekVsLastWeek([FromQuery] ReportFilterModel filter = null)
    // {
    ...
    // public async Task<IActionResult> ThisMonthVsLastMonth([FromQuery] ReportFilterModel filter = null)
    // {
    //     filter ??= new ReportFilterModel { TopCount = 10 };
    //     try
    //     {
    ...
    // public async Task<IActionResult> ThisYearVsLastYear([FromQuery] ReportFilterModel filter = null)
    // {
    //     filter ??= new ReportFilterModel { TopCount = 20 };
    //     try
    //     {
    ...
    // public async Task<IActionResult> Last30Days([FromQuery] ReportFilterModel filter = null)
    // {
    //     filter ??= new ReportFilterModel { TopCount = 15 };
    //     try
    //     {
    ...
    // public async Task<IActionResult> Last3Months([FromQuery] ReportFilterModel filter = null)
    // {
    //     filter ??= new ReportFilterModel { TopCount = 20 };
    //     try
    //     {
        ...
        [FromQuery] ReportFilterModel filter = null)
    {
        ...
        try
        {
            ...
            var result = await _customerReports.CompareDateRangesAsync(range1, range2, filter);
    ...
    [FromQuery] ReportFilterModel filter = null)
        {
            filter ??= new ReportFilterModel { TopCount = 5 };
            ...
            var result = await _customerReports.GetTopCustomersDateRangeAsync(startDate, endDate, filter);
    ...
    //son bir yılda en fazla sipariş veren 20 müşteri
        ...
        [FromQuery] ReportFilterModel filter = null)
    {
        ...
        var result = await _customerReports.GetInactiveCustomersAsync(timePeriod, filter);
